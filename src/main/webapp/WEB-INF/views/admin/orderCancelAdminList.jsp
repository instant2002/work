...
<div class="col-xs-12">
	<div class="col-xs-12 text-center" style="border: 1px solid #ddd; border-width: 2px 0px;">
		<h2><strong>고객 주문 취소 내역</strong></h2>
	</div>
			...
			<tbody>
				...
				<tr>
					...
					<td style="border-width: 1px 1px 1px 0px; "><a href="/admin/orderCancelDetail.do?order_code=${cancel_list.order_code }">
						...
						<font style="font-size: 12px;">아이디 : ${cancel_list.user_id}<br></font>
					...
					<td class="text-center" style="border-right: none;">
						...
						<button type="button" class="btn btn-buy-col pull-left add-cart" onclick="location.href='/admin/orderCancelDetail.do?order_code=${cancel_list.order_code }'" style="width: 100%; height: 30px; padding: 0;">
							상세보기
						</button>
					</td>
				</tr>
