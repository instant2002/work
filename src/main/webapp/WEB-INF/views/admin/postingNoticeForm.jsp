...
<form class="form-horizontal" id="postingNotice_form" action="/admin/postingNoticeSub.do" enctype="multipart/form-data" method="post">
	<fieldset>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				<input id="notice_order" name="notice_order" type="text" class="form-control input-md" maxlength="3">
			</div>
		</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4">
				...
				<div class="bootstrap-filestyle input-group">
					<input type="text" id="notice_img_name" class="form-control" name="notice_img_name" disabled=""> <span class="group-span-filestyle input-group-btn" tabindex="0" style="border: 1px solid #d7d9db;"> <label for="notice_img_file" class="btn btn-default " style="padding: 3px 17px;"> <span class="glyphicon fa fa-upload"></span>
					</label>
					</span>
				</div>
			</div>
		...
		<div class="form-group" id="attachments_area">
			<div id="file_inputs">
				...
				<div class="col-md-4" id="attachments">
					<p>
						<input type='file' multiple="multiple" name='notice_attFile'>
					</p>
				</div>
			</div>
		</div>
