...
<div class="login center-block">
   <form action="/member/loginSub.do" class="validation-engine" method="post">
      ...
      <input type="submit" name="login" class="btn login_btn btn-5margin" value="로그인">
      <input type="button" name="register" class="btn logout_btn btn-5margin" value="회원가입" onclick="location.href='registForm.do'">
   </form>
   <hr>
   <a href="#">아이디 찾기</a> |
   <a href="#">비밀번호 찾기</a>
