<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
    <h2 class="text-center"><strong>회원가입 약관 동의</strong></h2>
    <hr>
	<div class="col-xs-12 text-center hidden-xs" style="margin-bottom: 15px;">
		<span><b>(필수)회원가입 약관</b></span>
	</div>
...
※ 유니온북스 쇼핑몰은 공정거래위원회에서 심의한 표준약관을 사용하고 있음.  
  
공 정 거 래 위 원 회 
표준약관 제10023호   인터넷 사이버몰 利用標準約款 
-------------------------------------------------  

제1조(목적) 
이 약관은 유니온북스 회사(전자상거래 사업자)가 운영하는 유니온북스 사이버 몰(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리,의무 및 책임사항을 규정함을 목적으로 합니다. 
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다」

제2조(정의) 

① “몰” 이란 유니온북스 회사가 재화 또는 용역(이하 “재화등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
① “몰”은 이 약관의 내용과 상호 및 대표자 성명, 영업소 소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를 포함), 전화번호, 모사전송번호, 전자우편주소, 사업자등록번호, 통신판매업신고번호, 개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 유니온북스 사이버몰의 초기 서비스화면(전면)에 게시합니다. 다만, 약관의 내용은 이용자가 연결화면을 통하여 볼 수 있도록 할 수 있습니다.
...
④ “몰”이 제2항과 제3항에 의해 이용자의 동의를 받아야 하는 경우에는 개인정보관리 책임자의 신원(소속, 성명 및 전화번호, 기타 연락처), 정보의 수집목적 및 이용목적, 수집자에 대한 정보제공 관련사항(제공받은자, 제공목적 및 제공할 정보의 내용) 등 정보통신망이용촉진등에관한법률 제22조제2항이 규정한 사항을 미리 명시하거나 고지해야 하며 이용자는 언제든지 이 동의를 철회할 수 있습니다.
...
① “몰”은 법령과 이 약관이 금지하거나 공서양속에 반하는 행위를 하지 않으며 이 약관이 정하는 바에 따라 지속적이고, 안정적으로 재화와 용역을 제공하는데 최선을 다하여야 합니다.

② “몰”은 이용자가 안전하게 인터넷 서비스를 이용할 수 있도록 이용자의 개인정보(신용정보 포함)보호를 위한 보안 시스템을 갖추어야 합니다.

③ “몰”이 상품이나 용역에 대하여 「표시광고의공정화에관한법률」 제3조 소정의 부당한 표시광고행위를 함으로써 이용자가 손해를 입은 때에는 손해를 배상할 책임을 집니다.
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
   ...
   <div id="accordion-order" class="col-xs-12 hidden-sm hidden-md hidden-lg">
	   <div class="accordion-group panel">
			<a href="#collapse-1"  data-toggle="collapse" class="accordion-header collapsed"><b>(필수)회원가입 약관</b></a>
			<div class="collapse" id="collapse-1" style="height: 0px;">
				<div class="accordion-body">
					<div class="row">
						<div class="col-md-12" style="padding-top: 20px;">
							<pre style="white-space: pre-wrap;">-회원가입약관-
...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</pre>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="text-center">
		<input id="agree1" type="checkbox" name="checkbox" class="stl basket_checkbox_all hidden-sm hidden-md hidden-lg">
		<label for="agree1" class="stl"><span></span>회원가입 약관에 동의합니다.</label>
	</div>

	<div class="col-xs-12 text-center hidden-xs" style="margin: 40px 0 10px 0">
		<span><b>(필수)개인정보 수집 및 이용에 대한 안내</b></span>
	</div>
	<div id="accordion-order" class="col-xs-12 hidden-sm hidden-md hidden-lg" style="margin-top: 30px;">
		<div class="accordion-group panel">
			<a href="#collapse-2"  data-toggle="collapse" class="accordion-header collapsed"><b>(필수)개인정보 수집 및 이용 안내</b></a>
			<div class="collapse" id="collapse-2" style="height: 0px;">
				<div class="accordion-body">
					<div class="row">
						<div class="col-md-12" style="padding-top: 20px;">
<pre style="white-space: pre-wrap;">-개인정보 수집 및 이용에 대한 안내- 
...
ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산콘텐츠 제공 , 구매 및 요금 결제 , 물품배송 또는 청구지 등 발송ο 회원 관리회원제 서비스 이용에 따른 본인확인 , 개인 식별 , 불량회원의 부정 이용 방지와 비인가 사용 방지 , 가입 의사 확인 , 연령확인 , 만14세 미만 아동 개인정보 수집 시 법정 대리인 동의여부 확인 , 불만처리 등 민원처리 , 고지사항 전달ο 마케팅 및 광고에 활용이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 회원의 서비스 이용에 대한 통계
...
- 회원가입정보의 경우, 회원가입을 탈퇴하거나 회원에서 제명된 때- 대금지급정보의 경우, 대금의 완제일 또는 채권소멸시효기간의 만료된 때- 배송정보의 경우, 물품 또는 서비스가 인도되거나 제공된 때 (단, 상법 등 법령의 규정에 의하여 보존할 필요성이 있는 경우에는 예외로 합니다.) 
ο 위 보유기간에도 불구하고 계속 보유하여야 할 필요가 있을 경우에는 귀하의 동의를 받겠습니다.

□ 개인정보의 파기 절차 및 방법
회사는 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체없이 파기합니다. 파기절차 및 방법은 다음과 같습니다.
ο 파기절차회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된 후 별도의 DB로 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어집니다. 별도 DB로 옮겨진 개인정보는 법률에 의한 경우가 아니고서는 보유되어지는 이외의 다른 목적으로 이용되지 않습니다.
ο 파기방법 - 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.</pre>
						</div>
					</div>
				</div>
			</div>
...
ο 파기방법 - 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.
	...
	<div class="text-center">
		<input id="agree2" type="checkbox" name="checkbox" class="stl basket_checkbox_all hidden-sm hidden-md hidden-lg">
		<label for="agree2" class="stl"><span></span>개인정보 수집 및 이용에 대한 안내에 동의합니다.</label>
	</div>
   
    
	<div class="col-xs-12 text-center hidden-xs" style="margin: 40px 0 10px 0">
		<span><b>(필수)개인 정보 처리 방침</b></span>
	</div>
	<div id="accordion-order" class="col-xs-12 hidden-sm hidden-md hidden-lg" style="margin-top: 30px;">
		<div class="accordion-group panel">
			<a href="#collapse-3"  data-toggle="collapse" class="accordion-header collapsed"><b>(필수)개인 정보 처리 방침</b></a>
			<div class="collapse" id="collapse-3" style="height: 0px;">
				<div class="accordion-body">
					<div class="row">
						<div class="col-md-12" style="padding-top: 20px;">
						<pre style="white-space: pre-wrap;">-개인정보처리방침-
						
□ 총 칙 

ⅰ) 유니온북스는 귀하의 개인정보보호를 매우 중요시하며, 『정보통신망이용촉진등에관한법률』상의 개인정보보호 규정 및 정보통신부가 제정한 『개인정보보호지침』을 준수하고 있습니다. 
유니온북스는 개인정보보호방침을 통하여 귀하께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 

ⅱ) 유니온북스는 개인정보보호방침을 홈페이지 첫 화면에 공개함으로써 귀하께서 언제나 용이하게 보실 수 있도록 조치하고 있습니다. 

ⅲ) 유니온북스는 개인정보보호방침의 지속적인 개선을 위하여 개인정보보호방침을 개정하는데 필요한 절차를 정하고 있습니다. 
그리고 개인정보보호방침을 개정하는 경우 버전번호 등을 부여하여 개정된 사항을 귀하께서 쉽게 알아볼 수 있도록 하고 있습니다.

□ 개인정보 수집에 대한 동의 

유니온북스는 귀하께서 유니온북스의 개인정보보호방침 또는 이용약관의 내용에 대해 「동의한다」버튼 또는 「동의하지 않는다」버튼을 클릭할 수 있는 절차를 마련하여, 「동의한다」버튼을 클릭하면 개인정보 수집에 대해 동의한 것으로 봅니다. 

□ 개인정보의 수집목적 및 이용목적 

ⅰ) 유니온북스는 다음과 같은 목적을 위하여 개인정보를 수집하고 있습니다. 
...
유니온북스는 귀하에 대한 정보를 저장하고 수시로 찾아내는 '쿠키(cookie)'를 사용합니다. 쿠키는 웹사이트가 귀하의 컴퓨터 브라우저(넷스케이프, 인터넷 익스플로러 등)로 전송하는 소량의 정보입니다. 
귀하께서 웹사이트에 접속을 하면 유니온북스의 컴퓨터는 귀하의 브라우저에 있는 쿠키의 내용을 읽고, 귀하의 추가정보를 귀하의 컴퓨터에서 찾아 접속에 따른 성명 등의 추가 입력 없이 서비스를 제공할 수 있습니다. 쿠키는 귀하의 컴퓨터로 식별하지만 귀하를 개인적으로 식별하지는 않습니다. 
또한 귀하는 쿠키에 대한 선택권이 있습니다. 웹브라우저의 옵션을 조정함으로써 모든 쿠키를 다 받아들이거나, 쿠키가 설치될 때 통지를 보내도록 하거나, 아니면 모든 쿠키를 거부할 수 있는 선택권을 가질 수 있습니다. 

□ 목적외 사용 및 제3자에 대한 제공 

ⅰ) 유니온북스는 귀하의 개인정보를 <개인정보 수집목적 및 이용목적>에서 고지한 범위내에서 사용하며, 동 범위를 초과하여 이용하거나 타인 또는 타기업·기관에 제공하지 않습니다.
...
ⅱ) 유니온북스는 개인정보의 수집에 대한 동의철회(회원탈퇴)를 개인정보 수집시와 동등한 방법 및 절차로 행사할 수 있도록 필요한 조치를 하겠습니다. 
...
- 배송정보의 경우, 물품은 서비스가 인도되거나 제공된 때 (단, 상법 등 법령의 규정에 의하여 보존할 필요성이 있는 경우에는 예외로 합니다.) 

ⅱ) 위 보유기간에도 불구하고 계속 보유하여야 할 필요가 있을 경우에는 귀하의 동의를 받겠습니다.

□ 개인정보보호를 위한 기술적 대책

유니온북스는 귀하의 개인정보를 취급함에 있어 개인정보가 분실, 도난, 누출, 변조 또는 훼손되지 않도록 안전성 확보를 위하여 다음과 같은 기술적 대책을 강구하고 있습니다. 

ⅰ) 귀하의 개인정보는 비밀번호에 의해 보호되며, 파일 및 전송 데이터를 암호화하거나 파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의 보안기능을 통해 보호되고 있습니다.

ⅱ) 유니온북스는 백신프로그램을 이용하여 컴퓨터바이러스에 의한 피해를 방지하기 위한 조치를 취하고 있습니다. 백신프로그램은 주기적으로 업데이트되며 갑작스런 바이러스가 출현할 경우 백신이 나오는 즉시 이를 제공함으로써 개인정보가 침해되는 것을 방지하고 있습니다. 

ⅲ) 유니온북스는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게 전송할 수 있는 보안장치(SSL 또는 SET)를 채택하고 있습니다. 

ⅳ) 해킹 등에 의해 귀하의 개인정보가 유출되는 것을 방지하기 위해, 외부로부터의 침입을 차단하는 장치를 이용하고 있으며, 각 서버마다 침입탐지시스템을 설치하여 24시간 침입을 감시하고 있습니다. 

□ 개인정보의 위탁처리 

유니온북스는 서비스 향상을 위해서 귀하의 개인정보를 외부에 위탁하여 처리할 수 있습니다. 
...
유니온북스는 개인정보보호와 관련하여 귀하가 의견과 불만을 제기할 수 있는 창구를 개설하고 있습니다. 
개인정보와 관련한 불만이 있으신 분은 유니온북스의 개인정보 관리책임자에게 의견을 주시면 접수 즉시 조치하여 처리결과를 통보해 드립니다.
또는 정부에서 설치하여 운영중인 개인정보침해신고센터(http://www.cyberprivacy.or.kr, 전화 02-1336, PC통신 go eprivacy)에 불만처리를 신청할 수 있습니다. 

□ 개인정보 관리책임자 

유니온북스는 개인정보에 대한 의견수렴 및 불만처리를 담당하는 개인정보 관리책임자를 지정하고 있습니다. 개인정보 관리책임자는 다음과 같습니다. 
...
ⅰ) 유니온북스는 만14세 미만 아동의 개인정보를 수집하는 경우 법정대리인의 동의를 받습니다. 

ⅱ) 만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 유니온북스는 지체없이 필요한 조치를 취합니다.
						</pre></div>
					</div>
				</div>
			</div>
...
ⅱ) 만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 유니온북스는 지체없이 필요한 조치를 취합니다.</textarea>
	</div>
	<div class="text-center">
		<input id="agree3" type="checkbox" name="checkbox" class="stl basket_checkbox_all hidden-sm hidden-md hidden-lg">
		<label for="agree3" class="stl"><span></span>개인 정보 처리 방침에 동의합니다.</label>
	</div>
	<hr style="width: 100%; margin-bottom: 30px;">
	<div class="text-center">
		<input id="agree_all" type="checkbox" name="checkbox" class="stl basket_checkbox_all hidden-sm hidden-md hidden-lg">
		<label for="agree_all" class="stl"><span></span>유니온북스 인터넷 쇼핑몰의 모든 약관을 확인하고 전체 동의합니다.</label>
	</div>
	<div class="col-xs-12 text-center" style="margin: 40px 0;">
		<button class="btn btn-sm btn-yet-col" type="button" onclick="agreedFunc()">다음 단계</button>		
	</div>
	...
	$(document).ready(function(){
		   $("#agree_all").click(function(){
		      ...
		      $("[id^=agree]").prop("checked", isChecked);
		   });
		   
		   $("[id^=agree]").click(function(){
			      var isChecked = $(this).is(":checked");
			      var agreed_count = $("input[id^=agree]:checked").length;
			      if(agreed_count>=3){
				      $("#agree_all").prop("checked", isChecked);
			      }
			});
		});
	...
	function agreedFunc(){
		if(!$("#agree1").is(":checked")){
			alert("회원가입 약관 동의는 필수입니다.");
			return false;
		}
		
		if(!$("#agree2").is(":checked")){
			alert("개인정보 수집 및 이용에 대한 안내 동의는 필수입니다.");
			return false;
		}
		
		if(!$("#agree3").is(":checked")){
			alert("개인 정보 처리 방침 동의는 필수입니다.");
			return false;
		}
		$("#agreedRegist").submit();
	}
