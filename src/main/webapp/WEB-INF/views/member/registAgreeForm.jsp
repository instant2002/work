...
②“몰”과 이용자간에 제기된 전자상거래 소송에는 한국법을 적용합니다.</textarea>
   ...
   <div class="col-xs-12 text-center" style="margin-bottom: 30px;">
   	...
   	<label for="agree1">회원가입 약관에 동의합니다.</label>
   </div>
...
ο 파기방법 - 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.
   ...
   <div class="col-xs-12 text-center"  style="margin-bottom: 30px;">
   	...
   	<label for="agree2">개인정보 수집 및 이용에 대한 안내에 동의합니다.</label>
   </div>
...
ⅱ) 만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정, 동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 유니온북스는 지체없이 필요한 조치를 취합니다.</textarea>
	...
	<div class="col-xs-12 text-center" style="margin-bottom: 40px;">
	   	...
	   	<label for="agree3">개인 정보 처리 방침에 동의합니다.</label>
	   </div> 
	<hr style="width: 100%; margin-bottom: 30px;">
	<div class="col-xs-12 text-center" style="margin-bottom: 40px;">
	<input type="checkbox" id="agree_all"> 
	  	<label for="agree_all">유니온북스 인터넷 쇼핑몰의 모든 약관을 확인하고 전체 동의합니다.</label>
	</div>
	<div class="col-xs-12 text-center" style="margin-bottom: 40px;">
