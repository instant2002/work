...
public class PostCommand {
	...
	public String toString() {
		return "PostCommand [product_no=" + product_no + ", upload_date=" + upload_date + ", book_name=" + book_name
				...
				+ ", book_page=" + book_page + ", release_date=" + release_date + ", book_explanation="
				+ book_explanation + ", quantity=" + quantity + ", order_list=" + order_list + ", quantity_list="
				+ quantity_list + "]";
	}
}