...
public class MemberCommand {
	...
	public String toString() {
		return "MemberCommand [user_id=" + user_id + ", user_pwd=" + user_pwd + ", user_name=" + user_name + ", email="
				+ email + ", phonenum1=" + phonenum1 + ", phonenum2=" + phonenum2 + ", postnum=" + postnum
				+ ", address1=" + address1 + ", address2=" + address2 + ", birth=" + birth + ", gender=" + gender
				+ ", secession=" + secession + ", secession_contents=" + secession_contents + ", secession_num="
				+ secession_num + "]";
	}
}